package com.example.dnd_manager.screen.assets;
...
public class AssetManagerScreen extends BorderPane {
    ...
    private AssetManagerScreen(Stage stage, Consumer<Path> onAssetSelected, Runnable backToStartAction) {
        boolean isPickerMode = onAssetSelected != null;
        AssetManagerController controller = new AssetManagerController(isPickerMode, backToStartAction);
        AssetManagerTabPaneBuilder tabPaneBuilder = new AssetManagerTabPaneBuilder();
