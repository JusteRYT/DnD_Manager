...
import com.example.dnd_manager.application.service.CharacterExporter;
...
public class CharacterDescriptionFileExporter {
    ...
    public CharacterDescriptionFileExporter(CharacterDescriptionSaveChooser saveChooser) {
